...
resource "aws_sns_topic_subscription" "anomaly_email" {
  ...
  protocol  = "email"
  endpoint  = "alerts@yourcompany.com"  # Replace with actual email
}
...
resource "aws_redshift_cluster" "sensor_analytics" {
  ...
  master_password        = "TempPassword123!"  # Change in production
  node_type              = "dc2.large"
...
resource "aws_redshift_cluster_iam_roles" "sensor_analytics" {
  cluster_identifier = aws_redshift_cluster.sensor_analytics.cluster_identifier
...
resource "aws_lambda_function" "data_processor" {
  ...
  environment {
    variables = {
      ...
      REDSHIFT_CLUSTER   = aws_redshift_cluster.sensor_analytics.cluster_identifier
      REDSHIFT_DATABASE  = aws_redshift_cluster.sensor_analytics.database_name
      REDSHIFT_USER      = aws_redshift_cluster.sensor_analytics.master_username
    }
  }
...
output "redshift_cluster_endpoint" {
  ...
  value       = aws_redshift_cluster.sensor_analytics.endpoint
}

output "redshift_cluster_id" {
  description = "Redshift cluster identifier"
  value       = aws_redshift_cluster.sensor_analytics.cluster_identifier
}